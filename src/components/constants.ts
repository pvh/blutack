...
export const MIMETYPE_BOARD_CARD_DRAG_ORIGIN =
  "application/x-pushpin-board-source"
export const MIMETYPE_BOARD_CARD_DATA = "application/x-pushpin-board-cards"
export const MIMETYPE_CONTENT_LIST_INDEX = "application/x-pushpin-list-index"
